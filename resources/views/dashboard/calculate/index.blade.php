...
@section('content')
    ...
    @php
        $categorys = \App\Models\Category::select([
            ...
            ->leftJoin('products', 'products.id', '=', 'categories.product_id')
                ...
                <div class="modal-body">
                    ...
                    <form id="calForm">
                        ...
                        <div class="mb-33 d-flex justify-content-between">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="frameOriginal numericInput form-control" readonly
                                    name="frame" value="">
                            </div>
                        </div>
                        <div class="mb-33 d-flex justify-content-between">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="priceOriginal form-control" readonly name="price"
                                    value="">
                            </div>
                        </div>
                        <div class="mb-3">
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $.each(data, function(id, category_name) {
                            ...
                            $('#categorys').append('<option value="' + id + '">' +
                                category_name + '</option>');
                            $('#category_cal').append('<option value="' + id + '">' +
                                category_name + '</option>');
                        });
                    },
