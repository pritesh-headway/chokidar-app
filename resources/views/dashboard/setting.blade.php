                ...
                <div class="modal-body">
                    ...
                    <form id="taxesForm">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" value="<?php echo isset($taxs[0]->gst) ? $taxs[0]->gst : ''; ?>" id="gst"
                                name="gst" required>
                        </div>
                        @if ($taxs->isNotEmpty())
                                    ...
                                    @if ($value->tax != '' || $value->tax != null)
                                        <div id="tax-container">
                                            <div class="mb-3 d-flex align-items-center">
                                                <input type="text" class="form-control" value="<?php echo $value->tax; ?>"
                                                    name="tax[]" required>
                                                ...
                                                @else
                                                    <button type="button"
                                                        class="btn btn-danger remove-tax ms-2">-</button>
                                                @endif
                                            </div>
                                        </div>
                                    @endif
                                    ...
                                    @if ($value->flange != '' || $value->flange != null)
                                        <div id="flange-container">
                                            <div class="mb-3 d-flex align-items-center">
                                                ...
                                                @if ($loop->first)
                                                    <button type="button"
                                                        class="btn btn-success add-flange ms-2">+</button>
                                                @else
                                                    <button type="button"
                                                        class="btn btn-danger remove-flange ms-2">-</button>
                                                @endif
                                            </div>
                                        </div>
                                    @endif
